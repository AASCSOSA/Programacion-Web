    ...
    return (
        <div class="container" id="buttonsHome">
            <div class="btn-group" role="group" aria-label="Basic example">
                <div >
                    <Link to='/ventaForMonth'><button type="button" class="btn btn-primary" >Venta</button></Link>
                    <Link to='/rancho'><button type="button" class="btn btn-primary">Rancho</button></Link>
                    <Link to='/cargaForMonth'><button type="button" class="btn btn-primary">Carga</button></Link>
                ...
                <div class="btn-group" role="group" aria-label="Basic example">
                <div id="buttonsDown">
                <Link to='/pago_trabajadorForMonth'><button type="button" class="btn btn-primary">Pago de Trabajador</button></Link>
                <Link to='/fertilizante'><button type="button" class="btn btn-primary">Fertilizante</button></Link>
                <Link to='/fertilizacionForMonth'><button type="button" class="btn btn-primary">Fertilización</button></Link>
